...
Generally we will be sticking to [Hadley Wickham's R Style Guide](http://r-pkgs.had.co.nz/style.html) for all R code we write. Some important points to note are to try to stick to 80 characters per line (exceptions are made for `.Rmd` files or similar) and to use 2 spaces, not tabs!
