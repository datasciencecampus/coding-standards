...
Projects are managed using [`stack`](https://github.com/commercialhaskell/stack/blob/master/doc/GUIDE.md). However, `cabal` is also suitable. So long as the project can be passed on and compiles then whichever tool you use to sandbox your work is fine.
