...
code and is a good fit for Campus projects.


Data Science Campus projects are managed using `cabal` as the main preference.
However, `stack` is also suitable. So long as the project can be passed on and
compiles then whichever tool you use to sandbox your work is fine.
...
the code and indent the definitions in a `where` clause 2 spaces.
